...
import {
  ...
  Users, Calendar, Search, Sparkles,
} from 'lucide-react';
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* ── Sidebar ── */}
      <aside className="w-72 border-r border-white/5 bg-card/50 backdrop-blur-xl flex flex-col">
            ...
            <div className="space-y-1">
              {orgs.map(org => (
                ...
                >
                  ...
                  <Badge variant="outline" className="text-[10px] opacity-60">{org.role}</Badge>
                </button>
              ))}
            </div>
          )}
      ...
      <main className="flex-1 flex flex-col">
        {/* Header */}
        <header className="h-16 border-b border-white/5 bg-card/30 backdrop-blur-xl flex items-center justify-between px-6">
          <div>
            {selectedOrg ? (
              <div className="flex items-center gap-3">
                ...
                <Dialog open={showInvite} onOpenChange={setShowInvite}>
                  <DialogTrigger render={<Button variant="outline" size="sm" className="h-7 text-xs border-primary/20 hover:border-primary/50 gap-1" />}>
              ...
              <span className="text-muted-foreground">Select an organisation</span>
            )}
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          {!selectedOrg ? (
            <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
              ...
              <h2 className="text-2xl font-heading font-semibold">Welcome to LegalDesk</h2>
              <p className="text-muted-foreground max-w-sm">Select an organisation from the sidebar to view your cases, or create a new one to get started.</p>
            </div>
          ) : (
            <>
              <div className="flex items-center justify-between mb-6">
                ...
                <Dialog open={showNewCase} onOpenChange={setShowNewCase}>
                  <DialogTrigger render={<Button className="bg-gradient-to-r from-primary to-primary/80 text-white shadow-lg shadow-primary/25" />}>
